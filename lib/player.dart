...
final Map<int, Map<String, dynamic>> COMMAND_TO_STATUS = {
  0 : {"name" : "None", "con_damage" : 0, "effect" : 0, "range" : "None", "time" : -1},
  1 : {"name" : "power_up", "con_damage" : 0, "effect" : 5, "range" : "attack_buff", "time" : 10},
  2 : {"name" : "power_down", "con_damage" : 0, "effect" : -5, "range" : "attack_buff", "time" : 10},
  3 : {"name" : "defence_up", "con_damage" : 0, "effect" : 10, "range" : "defence_buff", "time" : 10},
  4 : {"name" : "defence_down", "con_damage" : 0, "effect" : -10, "range" : "defence_buff", "time" : 10},
  5 : {"name" : "regene_hp", "con_damage" : -3, "effect" : 0, "range" : "HP", "time" : 5},
  6 : {"name" : "regene_sp", "con_damage" : 0, "effect" : -3, "range" : "stamina", "time" : 5},
};
...
class Pouch {
  ...
  Pouch() {
    ...
    // this.pouch[1][0] = Item(777);
    // this.pouch[1][1] = Item(777);
    // this.pouch[1][2] = Item(777);
    // this.pouch[1][3] = Item(777);
    // this.pouch[1][4] = Item(777);
  }
...
class Player extends Pouch {
  ...
  void add_conditions(var rIndex, Map<String, dynamic> condition) {
    for (int i = 0; i < this.conditions.length; i++) {
      if(this.conditions[i]!["name"] == "None") {
        ...
        this.status["con_damage"] = this.status["con_damage"]! + condition["con_damage"] as int;
        if(rIndex != "bad") { // 正のステータスだった時
  ...
  void sub_conditions(int index) {
    ...
    this.status["con_damage"] = this.status["con_damage"]! - this.conditions[index]!["con_damage"] as int;
